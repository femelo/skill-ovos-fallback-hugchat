...
from skill_ovos_fallback_hugchat import DEFAULT_SETTINGS, HuggingChatSkill


class TestHuggingChatSkill(TestCase):
    ...
    def setUpClass(cls) -> None:
        # Get test skill
        cls.skill = HuggingChatSkill(skill_id=cls.test_skill_id, bus=cls.bus)
